...
# ********************************************************************
# Sort the different sections of the KG and deduplicate them.  The
# deduplicated output is sorted, which should yield better performance
# when the edges are loaded into the graph cache is a later script.
